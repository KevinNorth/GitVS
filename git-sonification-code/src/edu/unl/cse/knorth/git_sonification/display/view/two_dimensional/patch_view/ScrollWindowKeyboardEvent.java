...
public class ScrollWindowKeyboardEvent extends KeyboardEvent<PatchViewState> {
    ...
    @Override
    public void onKeyDown(PatchViewState state) {
        // Do nothing
    }

    @Override
    public void whileKeyHeld(PatchViewState state, long delta) {
    ...
    @Override
    public void onKeyUp(PatchViewState state) {
        // Do nothing
    }
